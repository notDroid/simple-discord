...
async def test_simulation_multi_chat_isolation(client: AsyncClient, api_path: str):
    ...
    chat2_fail = await client.get(f"{api_path}/chats/{chat_2_id}", params={"user_id": user_b})
